...
export type UserRole = "admin" | "bd" | "developer"

export type LeadStatus = "new" | "interview_scheduled" | "test_assigned" | "completed"

export type LeadSource = "website" | "referral" | "linkedin" | "job_board" | "other"
...
export const userSchema = z.object({
  name: z.string().min(2, "Name must be at least 2 characters"),
  email: z.string().email("Invalid email address"),
  role: z.enum(["admin", "bd", "developer"]),
  password: z.string().min(6, "Password must be at least 6 characters"),
})
