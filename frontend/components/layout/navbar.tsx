        ...
        <div className="flex items-center gap-3">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 hover:bg-gray-50">
                ...
                <div className="hidden sm:block text-left">
                  <p className="text-sm font-medium text-gray-900 capitalize">{user?.username || "Admin"}</p>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <DropdownMenuSeparator />
              <LogoutDialog open={logoutOpen} onOpenChange={setLogoutOpen} onLogout={handleLogout} withTrigger={true} />
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
