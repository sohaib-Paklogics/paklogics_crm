...
export default function KanbanPage() {
  ...
  const canDragDrop = hasPermission({ action: "read", resource: "users" });
                ...
                <div key={column.id} className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <h3 className="font-semibold text-validiz-brown">
                        {column.title}
                      </h3>
                    </div>
                    <Badge
              ...
              {columns.map((column) => {
                ...
                return (
                  <div key={column.id} className="text-center">
                    <div
                      className={`w-4 h-4 rounded-full ${column.color} mx-auto mb-2`}
                    />
